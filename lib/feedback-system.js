...
class FeedbackSystem {
  ...
  formatSurveyPrompt(survey) {
    const prompts = {
      quick: {
        greeting: "Thanks for using our service! 🏙️",
  ...
  generateFeedbackResponse(feedbackRecord) {
    const responses = [
      "Thank you for helping make Memphis services better! 🏙️",
  ...
  getFeedbackTemplates() {
    return {
      post_service: {
        ...
        thank_you: "Thanks for helping make Memphis services better! 🏙️"
      },
      ...
      annual_survey: {
        introduction: "Hey Memphis! Once a year we ask for your thoughts on city services. 🏛️",
...
const feedbackResponsePatterns = {
  satisfied: {
    positive: [
      ...
      "Memphis residents like you make our job worth it! 🏙️",
  ...
  neutral: {
    acknowledgment: [
      ...
      "We hear you and we'll keep working to do better. 🛠️",
