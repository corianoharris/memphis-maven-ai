...
class WeeklyDataScrapingSystem {
  constructor() {
    this.scrapingSources = {
      memphis311: {
        baseUrl: 'https://memphistn.gov/311',
        selectors: {
      ...
      memphis211: {
        baseUrl: 'https://tn211.org/search/memphis',
        selectors: {
      ...
      memphisParks: {
        baseUrl: 'https://memphistn.gov/parks',
        selectors: {
          events: '.event-card',
  ...
  async scheduleScrapingJobs() {
    ...
    // Start all jobs
    this.scheduledJobs.forEach(job => job.job.start());
   ...
   */
  stopScheduledJobs() {
    this.scheduledJobs.forEach(job => job.job.stop());
